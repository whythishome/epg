...
module.exports = {
  ...
  url: function ({ date, channel }) {
    ...
    const url = `https://${requestDomain}/tvschedules/tvguide/${providerId}/web?start=1734271200&duration=120&channelSourceIds=${channelSourceIds}&apiKey=DI9elXhZ3bU6ujsA2gXEKOANyncXGUGc`;
